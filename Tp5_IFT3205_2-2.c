...
void
tcd_cancel(float** tcd_imagette, int last_coef) {
    int n = 8;
    int x, y;
    int max, i;
...
void
zigzag_denoise(float** image, int length, int width, int last_coef) {
...
int main(int argc,char** argv)
{
    ...
    for(n=0; n<64; n++) {
        ...
        zigzag_denoise(img_denoise, length, width, n);
    ...
    zigzag_denoise(img_denoise, length, width, best_n);
